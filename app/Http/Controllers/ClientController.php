...
class ClientController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect('/consultar')->with('message','Agendamento cadastrado!');;
    }
    
    public function destroy($id) {
        agendamentos::findOrFail($id)->delete();
        
        return redirect('/consultar')->with('message','Agendamento excluido!');
    }
    ...
    public function update(Request $request) {
        ...
        return redirect('/consultar')->with('message','Agendamento editado!');
    }
}
